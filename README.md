...
![Link Manager 创建与部署](./docs/images/screenshot-create.png)

查看部署完成后的域名：

![Link Manager 部署后的域名](./docs/images/screenshot-domain.png)

首次访问时，会看到登录页面（默认密码见下方）：

![Link Manager 登录界面](./docs/images/screenshot-login.png)
